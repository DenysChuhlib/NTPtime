...
<a id="features"></a>
### Особливості
Можна підключити одну з декількох частин бібліотеки. 
- `NTPtime.h` - Отримання часу з NTP сервера на основі UNIXtime, підключає всі інші частини
- `UNIXtime.h` - Основний об'єкт UNIXtime який має безліч можливостей, підключає TimeFunc
- `TimeFunc.h` - Глобальний об'єкт TimeFunc з майже всима основними функціями обчислювання, крайня частина
